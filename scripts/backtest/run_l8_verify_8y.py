#!/usr/bin/env python3
"""
equity_factor L8D2 (winner) 8 年验证 (2018-2026).

跑 2 个对照:
  - verify8y-L8-base : 当前 yaml (fcf_yield=0.20)
  - verify8y-L8D2    : fcf_yield=0 (winner，4y +0.096 Sharpe)

验证 winner 在牛/熊全周期不过拟合。每个 ~80 分钟。
"""
...
EXPERIMENTS: list[tuple[str, dict, dict]] = [
    ("verify8y-L8-base", {}, {}),
    ("verify8y-L8D2-no_fcf", {}, {"fcf_yield": 0.0}),
]
...
def main():
    ...
    out_md = ROOT / "data/backtest/equity_factor_l8_verify_8y_summary.md"
    lines = [
        "# equity_factor L8D2 8 年验证", "",
