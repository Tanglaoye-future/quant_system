...
def main():
    ...
    for tr in open_trades:
        ...
        sig = check_exit_signal(
            ...
            momentum_stop_pct=float(strat.get("momentum_stop_pct", 0.05)),
            dead_money_days=int(strat.get("dead_money_days", 5)),
            dead_money_pct=float(strat.get("dead_money_pct", 0.02)),
