...
- [三层解耦 Phase 0 — Postgres 基建 2026-05](db_decouple_phase0_2026-05.md) — 单 repo+强边界 改造启动；Postgres 作运营真相源；schema(规范化+JSONB) + alembic 首迁移 e5219b17f156 起库验证零漂移；Phase 1-4 路线
