...
- [三层解耦 P0-P2 — Postgres+repo+双写 2026-05](db_decouple_phase0_2026-05.md) — 单repo强边界；P0 schema+alembic；P1 repo DAO+路由DB-first/JSON fallback；P2 daily双写(ingest层,env QUANT_PG_DUALWRITE)；下一步P3切DB-only
