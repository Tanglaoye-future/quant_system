...
- [三层解耦 Phase 0+1 — Postgres + repo 层 2026-05](db_decouple_phase0_2026-05.md) — 单 repo+强边界；Postgres 真相源；P0 schema+alembic 起库；P1 repo DAO+路由 DB-first/JSON fallback；下一步 P2 daily 双写
