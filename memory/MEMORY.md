...
- **[2026-06-12 zhuang Wyckoff thesis 证伪](zhuang_thesis_wyckoff_falsified_2026-06-12.md)** ⭐ — 价跌量缩入场全崩 (ΔSharpe -0.78~-1.13) + 放量派发出场 8y 微输 baseline；alpha 在突破端不在抄底端
...
- **[2026-06-11 L2 vendor 评估 → 保持公开数据](l2_vendor_evaluated_keep_public_2026-06.md)** ⭐ — TradingView 否决（无 API/ToS/同源）+ 7 家 vendor 决策表（Tushare ¥3k-15k / JQData 免费 / 通联 ¥1-5 万 / iFinD ¥4 万机构门槛 / Wind ¥18 万）；用户选公开数据；复活条件 = JQData 免费分钟级 precheck 通过门才付费
